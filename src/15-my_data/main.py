...
start_point = (44.828687, -0.564033)  # not exact position
...
fig.text(x=0.75, y=0, s="My Data - Joseph Barbier", font=fontbold, size=8, ha="right")
...
plt.tight_layout()
plt.savefig("src/15-my_data/my_data.png", dpi=500, bbox_inches="tight")
