...
province_to_annotate = {
    ...
    "Hainan": {"location": (3, 0), "rotation": 0},
    "Inner Mongolia": {"location": (-3, -0.8), "rotation": 24},
}
...
fig.text(x=0.97, y=0.4, s="China's population", size=14, ha="right", va="top")
fig.text(
    x=0.97,
    y=0.36,
    s="95% of the population live in less than\n50% of the total area.",
    size=6,
    ha="right",
    va="top",
    color="grey",
...
fig.text(
    x=0.2,
    y=0.1,
    s=f"Guangdong ({197_100/9_650_000*100:.1f}% of total area) has {126_570_000/1_411_778_000*100:.1f}% of the total population",
    size=6,
)

plt.tight_layout()
plt.savefig("src/12-time_and_space/time_and_space.png", dpi=500, bbox_inches="tight")
